      ...
      if (trialRequest && trialRequest.id) {
        try {
          ...
          const normalizedData = {
            ...
            trial_request_date: trialRequestData.trialRequest?.trial_request_date || trialRequestData.trial_request_date || '',
          ...
          const formDataUpdate = {
            trial_request_date: normalizedData.trial_request_date,
